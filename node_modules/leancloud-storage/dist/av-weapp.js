...
var useAdatpers = __webpack_require__(171);
...
__webpack_require__(168)(AV);

AV.Conversation = __webpack_require__(169);
...
var adapters = __webpack_require__(172);
...
var _weakMap = __webpack_require__(184);
...
var _getOwnPropertySymbols = __webpack_require__(190);

var _getOwnPropertySymbols2 = _interopRequireDefault(_getOwnPropertySymbols);

var _assign2 = __webpack_require__(192);
...
var request = function request(url, options) {
    ...
    if (signal === null || signal === void 0 ? void 0 : signal.aborted) {
        return _promise2.default.reject(new AbortError("Request aborted"));
    }
    return new _promise2.default(function (resolve, reject) {
        var task = wx.request({
            url: url,
